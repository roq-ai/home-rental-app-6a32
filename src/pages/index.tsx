  ...
  return (
    ...
    >
      ...
      {data == undefined ? (
        ...
        <Grid templateColumns={{ lg : showMap ? '1fr 1fr' : '1fr',md : '1fr'}} gap={4}>
          <Box height="500px" overflowY={showMap && "auto"} >
            ...
            {data && showMap && (
              <Box flex={1} flexBasis={0} height={500} rounded="md" display={{lg:'block',extra:'block',md:'none',sm:'none',base:'none'}} >
